...
# define vcs_INT_TO_PTR(X)  ((void*)(__PTRDIFF_TYPE__)(X))
# define vcs_PTR_TO_INT(X)  ((int)(__PTRDIFF_TYPE__)(X))
#elif !defined(__GNUC__)       /* Works for compilers other than LLVM */
# define vcs_INT_TO_PTR(X)  ((void*)&((char*)0)[X])
# define vcs_PTR_TO_INT(X)  ((int)(((char*)X)-(char*)0))
#else                          /* Generates a warning - but it always works */
# define vcs_INT_TO_PTR(X)  ((void*)(X))
# define vcs_PTR_TO_INT(X)  ((int)(X))
#endif
