...
all: Rep.Lib.CSharp.dll test.exe

Rep.Lib.CSharp.dll: $(SOURCES)
	$(CSC) $(SOURCES) -out:Rep.Lib.CSharp.dll -debug -target:library -r:ICSharpCode.SharpZipLib

test.exe: Rep.Lib.CSharp.dll
	$(CSC) -r:Rep.Lib.CSharp.dll -debug test.cs
